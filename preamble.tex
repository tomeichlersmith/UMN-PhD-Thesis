...
\usepackage{slantsc} % allow to combine italics and small caps
% would work according to slantsc as long as font provides slant variants of small caps
\newcommand{\babar}{{\itshape\scshape BaBar}\xspace}
