...
For optimizing the other selections and estimating the sensitivity of \ac{hps},
$p_m < 2.8$ is used.
...
In this region of parameter space, \textsc{Experiment}\todo[lookup]{what experiment set the 1e-6 line?}
