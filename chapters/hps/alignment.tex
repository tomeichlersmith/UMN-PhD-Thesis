...
\todo[more]{give more detail on software and what I actually did for HPS alignment}
...
\begin{figure}
  \centering
  \todo[rotate]{Try rotating figure by 90 degrees}
...
\begin{figure}
  \centering
  \todo[rotate]{Try rotating figure by 90 degrees}
  \todo[figure]{Add $\Delta$ to the coordinate labels}
