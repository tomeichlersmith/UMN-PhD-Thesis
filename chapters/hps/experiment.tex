...
interact -- these two vertices determine that such a visible decay is subsequently less
...
such that it can collect data whenever CLAS-12 is not operational (for example,
