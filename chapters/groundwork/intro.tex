...
studying.\footnote{ The distinction between fundamental and effective vertices is not a well
...
this fact.\todo[more]{make sure to reference back to softness of sm brem in experiment sections.}
...
frequency with which we see \(K_0\) compared to \(\overline{K}_0\)\todo[citation]{Neutral kaon
  mixing citation}. We can also use our model of the kaons (as composed of quarks) and calculate this
