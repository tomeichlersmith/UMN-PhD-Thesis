...
\begin{todoenv}
Dive/derive brem differential xsec at LO. Comment on how it is primarily forward and low energy.
\end{todoenv}
...
\begin{todoenv}
  Example of K-short which is understood (mostly) within the context of the SM and has a
visible signature.
\end{todoenv}
