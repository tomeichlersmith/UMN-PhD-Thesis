...
\ac{grav-lens} and is observed and well modeled by \ac{gr}'s predictions \cite{gravlensing-2004}.
...
These Baryon Acoustic Oscillations (\ac{bao}) are imprinted on
our snapshot of this early-universe plasma, the Cosmic Microwave Background (\ac{cmb}), 
...
this postulated massive boson as a \ac{dark-photon}. Without any additional assumptions, this new
\ac{dark-photon} does not interact with any standard matter, so we also assume that some
...
partition this category of models depending on what happens to the \ac{dark-photon} after we
