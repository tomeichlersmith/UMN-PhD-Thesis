...
(\cref{fig:dm-mass-scale}). If the mass is too high ($\gtrapprox 100~\text{TeV}$), the \ac{dm} will be
...
universe with only \ac{sm} particles provides the lower limit; allowing a \ac{dm} mass $\lesssim\qty{1}{\MeV}$
would then break the consistency between this model and several predictions
