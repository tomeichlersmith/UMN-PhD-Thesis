...
(\cref{fig:dm-mass-scale}). If the mass is too high ($\gtrsim 100~\text{TeV}$), the \ac{dm} will be
too strongly coupled to the standard matter and would be over-produced within the early universe.
Highly precise agreement between nuclear abundance observations and predictions from a model of the early
universe with only \ac{sm} particles provides the lower limit; allowing a thermal relic \ac{dm} mass
$\lesssim\qty{1}{\MeV}$ would then break the consistency between this model and several of its predictions
\cite{nucleosynthesis-1998,bbn-constrain-dm-2015,bbn-pdg-review-2023}.
