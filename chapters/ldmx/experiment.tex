...
\todo{restructure}{
	Start experiment chapter with signature we are looking for
	and then go through the background cascade to motivate the LDMX design
	(then given overview of LDMX design). Include diagrams of the primary
	backgrounds to help give context.
}
...
Laboratory. The SLAC Linac can provide high energy, high rate, and low intensity\todo[correctness]{
	I think I mean low current here, i.e. few electrons per bunc.} electron beams for
...
\todo[restructure]{Move describing TS to last since we can motivate its existence
	and design by discussing the ECal and how the Tracker is not fast enough.}
\begin{enumerate}
...
\todo[restructure]{Move ME DM search introduction to beginning of analysis section.}
