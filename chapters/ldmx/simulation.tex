...
\todo[set scale]{Give number of particle estimates to help set the scale of interactions and particles.}
...
\begin{figure}
  \centering
  \todo[figure cleanup]{Comment about phase space requirement, maybe include showing
  how the distribution evolves with the phase space requirement and then the trigger requirement.}
  \begin{subfigure}{0.48\textwidth}
