...
Biasing and filtering methodology, configuration for EaT-specific backgrounds. \todo[copy]{Copy
  MidShower Parameters appendix from EaT internal note.}

\subsection{Validation}
Validation of this methodology. \todo[copy]{Copy background sample validation appendices from EaT
  internal note.}
