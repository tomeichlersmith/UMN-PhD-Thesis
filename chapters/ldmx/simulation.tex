...
\todo[intro]{Need to introduce concepts of ``nuclear'' energy, trigger, reconstructed energy, and gamma conversion to muons in order to properly comment on the plot.}
