...
\begin{frame}{Basic, Fixed Selection}
  \begin{itemize}
    ...
    \item \boldcol{UMNSunny}{Low Momentum Sum}:
      ...
      \begin{itemize}
        \item Keeping same signal region as L1L1
      \end{itemize}
    ...
    \item \boldcol{UMNSunny}{Mass Window}: $p_m < 2.8$ (exclusion), $p_m < 1.5$ (search SR),
      ...
      \begin{itemize}
        \item Same mass window sizes as L1L1
      \end{itemize}
  \end{itemize}
  $$
  ...
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        ...
        \item ``Simple Merging'' combination of OIM results with L1L1
          \begin{itemize}
            \item Slightly extends reach in core sensitivity region,
              probably disregard L1L2 results for $m_{V_D} > \gtrsim \qty{80}{\MeV}$
          \end{itemize}
      \end{itemize}
      \begin{center}
